...
} from 'lib/application/utils/user'
import { CocktailPostForm } from 'lib/application/types/cocktail'
import { CocktailPostStep2Form } from 'lib/application/types/cocktail'
import { CocktailPostStep1Form } from 'lib/application/types/cocktail'
...
const usePostCreate = (cocktailDraft?: CocktailPostDraft) => {
  ...
  const saveDraft = async () => {
    ...
    try {
      ...
      else router.replace(paths.drafts)
