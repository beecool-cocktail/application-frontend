...
export const CocktailApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        updateCocktailDraft: async (id: number, body: UpdateDraftArticleRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            assertParamExists('updateCocktailDraft', 'body', body)
            const localVarPath = `/cocktail-drafts/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const CocktailApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getCocktail(page: number, pageSize: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetPopularCocktailListResponse>> {
         ...
         * @throws {RequiredError}
         */
        async getCocktailByIDRequest(id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetCocktailByIDResponse>> {
         ...
         * @throws {RequiredError}
         */
        async getCocktailDraft(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetDraftCocktailListResponse>> {
         ...
         * @throws {RequiredError}
         */
        async getCocktailDraftByIDRequest(id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetCocktailDraftByIDResponse>> {
...
export const CocktailApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getCocktail(page: number, pageSize: number, options?: any): AxiosPromise<GetPopularCocktailListResponse> {
         ...
         * @throws {RequiredError}
         */
        getCocktailByIDRequest(id: number, options?: any): AxiosPromise<GetCocktailByIDResponse> {
         ...
         * @throws {RequiredError}
         */
        getCocktailDraft(options?: any): AxiosPromise<GetDraftCocktailListResponse> {
         ...
         * @throws {RequiredError}
         */
        getCocktailDraftByIDRequest(id: number, options?: any): AxiosPromise<GetCocktailDraftByIDResponse> {
...
export const LoginApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        googleAuthenticateRequest: async (body?: GoogleAuthenticateRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/google-authenticate`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const LoginApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async googleAuthenticateRequest(body?: GoogleAuthenticateRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GoogleAuthenticateResponse>> {
...
export const LoginApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        googleAuthenticateRequest(body?: GoogleAuthenticateRequest, options?: any): AxiosPromise<GoogleAuthenticateResponse> {
...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        collectArticleRequest: async (body?: CollectArticleRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/users/favorite-cocktails`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getUserFavoriteList: async (page: number, pageSize: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'page' is not null or undefined
            assertParamExists('getUserFavoriteList', 'page', page)
            // verify required parameter 'pageSize' is not null or undefined
            assertParamExists('getUserFavoriteList', 'pageSize', pageSize)
            const localVarPath = `/users/favorite-cocktails`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
        ...
        removeCollectionArticle: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/users/favorite-cocktails/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
        ...
        updateUserInfoRequest: async (body?: UpdateUserInfoRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/user/edit-info`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const UserApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getUserFavoriteList(page: number, pageSize: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetUserInfoResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getUserFavoriteList(page, pageSize, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get user id, name, email, numberOfPost, numberOfCollection and photo.
         ...
         * @throws {RequiredError}
         */
        async info(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetUserInfoResponse>> {
         ...
         * @throws {RequiredError}
         */
        async updateUserInfoRequest(body?: UpdateUserInfoRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UpdateUserInfoResponse>> {
...
export const UserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getUserFavoriteList(page: number, pageSize: number, options?: any): AxiosPromise<GetUserInfoResponse> {
            return localVarFp.getUserFavoriteList(page, pageSize, options).then((request) => request(axios, basePath));
        },
        /**
         * Get user id, name, email, numberOfPost, numberOfCollection and photo.
         * @summary Get user information.
         ...
         * @throws {RequiredError}
         */
        info(options?: any): AxiosPromise<GetUserInfoResponse> {
         ...
         * @throws {RequiredError}
         */
        updateUserInfoRequest(body?: UpdateUserInfoRequest, options?: any): AxiosPromise<UpdateUserInfoResponse> {
...
export class UserApi extends BaseAPI {
     ...
     * @memberof UserApi
     */
    public getUserFavoriteList(page: number, pageSize: number, options?: AxiosRequestConfig) {
        return UserApiFp(this.configuration).getUserFavoriteList(page, pageSize, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public logoutRequest(body?: LogoutRequest, options?: AxiosRequestConfig) {
        return UserApiFp(this.configuration).logoutRequest(body, options).then((request) => request(this.axios, this.basePath));
    }
